...
{
	var unit_id     = "1466868";
	var client_ip   = "125.76.224.163";
	var server_time = "1300404875";
	var verify_code = "793cad4c";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/1466868/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
